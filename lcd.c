...
;Da der µC C8051F340 viel schneller getaktet ist, als das LCD-Display es verarbeiten kann,
;mussten die Warteschleifen entsprechend angepasst werden!
*/
...
#include <C_8051F340.h>						//	Registeradressen											
#include <intrins.h>						// für _crol_ -Funktion									
#include <stdio.h>							//	für sprintf													

unsigned char LCD_PORT;	
#define LCD_PORT P0 						//	LCD-Display an P3 im Port-4-Bit-Modus		
